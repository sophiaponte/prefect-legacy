...
"""
try:
    from prefectlegacy.tasks.gcp.storage import GCSDownload, GCSUpload, GCSCopy, GCSBlobExists
    from prefectlegacy.tasks.gcp.secretmanager import GCPSecret
    from prefectlegacy.tasks.gcp.bigquery import (
        BigQueryTask,
    ...
    raise ImportError(
        'Using `prefectlegacy.tasks.gcp` requires Prefect to be installed with the "gcp" extra.'
    ) from err
