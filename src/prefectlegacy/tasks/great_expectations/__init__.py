...
"""
try:
    from prefectlegacy.tasks.great_expectations.checkpoints import (
        RunGreatExpectationsValidation,
    )
except ImportError as err:
    raise ImportError(
        'Using `prefectlegacy.tasks.great_expectations` requires Prefect to be installed with the "ge" extra.'
    ) from err
