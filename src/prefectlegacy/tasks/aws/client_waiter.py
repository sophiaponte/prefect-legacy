...
from prefectlegacy.tasks.aws import waiters
...
class AWSClientWait(Task):
    ...
    Args:
        ...
        - waiter_name (str, optional): The name of the waiter to instantiate. Can be a boto-supported
            ...
            find the definitions for all prefect-defined waiters [here](https://github.com/PrefectHQ/prefect/tree/master/src/prefectlegacy/tasks/aws/waiters).  # noqa
