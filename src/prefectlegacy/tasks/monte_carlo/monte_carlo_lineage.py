...
from prefectlegacy.tasks.monte_carlo.client import MonteCarloClient
...
class MonteCarloCreateOrUpdateLineage(Task):
    ...
    def run(
        ...
        the task creates tags with information from prefectlegacy context
...
def get_prefect_context_tags() -> List[Dict[str, Any]]:
    ...
    """
    return [
        dict(propertyName="flow_id", propertyValue=str(prefectlegacy.context.get("flow_id"))),
        dict(
            propertyName="flow_name",
            propertyValue=str(prefectlegacy.context.get("flow_name")),
        ),
        dict(
            propertyName="flow_run_id",
            propertyValue=str(prefectlegacy.context.get("flow_run_id")),
        ),
        dict(
            propertyName="flow_run_name",
            propertyValue=str(prefectlegacy.context.get("flow_run_name")),
        ),
        dict(
            propertyName="flow_run_version",
            propertyValue=str(prefectlegacy.context.get("flow_run_version")),
        ),
        dict(
            propertyName="project_id",
            propertyValue=str(prefectlegacy.context.get("project_id")),
        ),
        dict(
            propertyName="project_name",
            propertyValue=str(prefectlegacy.context.get("project_name")),
        ),
        dict(
            propertyName="scheduled_start_time",
            propertyValue=str(prefectlegacy.context.get("scheduled_start_time")),
        ),
        dict(
            propertyName="execution_start_time",
            propertyValue=str(prefectlegacy.context.get("date")),
        ),
        dict(propertyName="task_id", propertyValue=str(prefectlegacy.context.get("task_id"))),
        dict(
            propertyName="task_run_id",
            propertyValue=str(prefectlegacy.context.get("task_run_id")),
        ),
        dict(
            propertyName="task_run_name",
            propertyValue=str(prefectlegacy.context.get("task_run_name")),
        ),
        dict(
            propertyName="task_slug",
            propertyValue=str(prefectlegacy.context.get("task_slug")),
        ),
        dict(
            propertyName="task_name",
            propertyValue=str(prefectlegacy.context.get("task_name")),
        ),
        dict(
            propertyName="task_full_name",
            propertyValue=str(prefectlegacy.context.get("task_full_name")),
        ),
        dict(
            propertyName="task_run_count",
            propertyValue=str(prefectlegacy.context.get("task_run_count")),
        ),
        dict(
            propertyName="map_index",
            propertyValue=str(prefectlegacy.context.get("map_index")),
        ),
        dict(
            propertyName="parameters",
            propertyValue=str(prefectlegacy.context.get("parameters")),
        ),
        dict(
            propertyName="running_with_backend",
            propertyValue=str(prefectlegacy.context.get("running_with_backend")),
        ),
    ]
