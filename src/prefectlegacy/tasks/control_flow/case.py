...
class case(object):
    ...
    def __enter__(self):
        self.__prev_case = prefectlegacy.context.get("case")
        prefectlegacy.context.update(case=self)

    def __exit__(self, *args):
        if self.__prev_case is None:
            prefectlegacy.context.pop("case", None)
        else:
            prefectlegacy.context.update(case=self.__prev_case)
