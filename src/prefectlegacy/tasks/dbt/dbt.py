...
class DbtShellTask(ShellTask):
    ...
    [ShellTask](https://docs.prefectlegacy.io/api/latest/tasks/shell.html#shelltask).
    ...
    def run(
        ...
        Raises:
            - prefectlegacy.engine.signals.FAIL: if command has an exit code other
                than 0
        """
...
class DbtCloudRunJob(Task):
    ...
    Raises:
        - prefectlegacy.engine.signals.FAIL: whether there's a HTTP status code != 200
