...
class Schedule:
    ...
    Args:
        - clocks (List[prefectlegacy.schedules.clocks.Clock]): one or more clocks that emit events
    ...
    def __init__(
        self,
        clocks: List["prefectlegacy.schedules.clocks.Clock"],
    ...
    def _get_clock_events(
    ...
    ) -> Iterable["prefectlegacy.schedules.clocks.ClockEvent"]:
        """
        ...
        )  # type: Iterable[prefectlegacy.schedules.clocks.ClockEvent]
...
def IntervalSchedule(
    ...
    return Schedule(
        clocks=[
            prefectlegacy.schedules.clocks.IntervalClock(
...
def CronSchedule(
    ...
    *the first time* 2am is reached, 120 minutes later. Longer clocks, such as one
    ...
    return Schedule(
        clocks=[
            prefectlegacy.schedules.clocks.CronClock(
...
def RRuleSchedule(
    ...
    """
    return Schedule(
        clocks=[prefectlegacy.schedules.clocks.RRuleClock(rrule_obj, start_date, end_date)]
    )
