"""
The functions here have been moved to `prefectlegacy.backend.artifacts`
"""
# flake8: noqa
import warnings
from typing import Optional

from prefectlegacy.backend import (
...
def create_link(link: str) -> Optional[str]:
    ...
    """
    warnings.warn(
        "`prefectlegacy.artifacts.create_link` has been moved to `prefectlegacy.backend.create_link_artifact`. "
...
def update_link(task_run_artifact_id: str, link: str) -> None:
    ...
    """
    warnings.warn(
        "`prefectlegacy.artifacts.update_link` has been moved to `prefectlegacy.backend.update_link_artifact`. "
        "Please update your imports. This import path will be removed in 1.0.0."
    )
...
def create_markdown(markdown: str) -> Optional[str]:
    ...
    """
    warnings.warn(
        "`prefectlegacy.artifacts.create_markdown` has been moved to `prefectlegacy.backend.create_markdown_artifact`. "
        "Please update your imports. This import path will be removed in 1.0.0."
    )
...
def update_markdown(task_run_artifact_id: str, markdown: str) -> None:
    ...
    """
    warnings.warn(
        "`prefectlegacy.artifacts.update_markdown` has been moved to `prefectlegacy.backend.update_markdown_artifact`. "
        "Please update your imports. This import path will be removed in 1.0.0."
    )
...
def delete_artifact(task_run_artifact_id: str) -> None:
    ...
    """
    warnings.warn(
        "`prefectlegacy.artifacts.delete_artifact` has been moved to `prefectlegacy.backend.delete_artifact`. "
        "Please update your imports. This import path will be removed in 1.0.0."
    )
