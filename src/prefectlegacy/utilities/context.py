...
(https://docs.prefectlegacy.io/core/concepts/configuration.html) object that is being used \
during this run |
...
from prefectlegacy.utilities.collections import DotDict, merge_dicts
...
class Context(DotDict, threading.local):
    ...
    def __getstate__(self) -> None:
        ...
        raise TypeError(
            ...
            "access context as an attribute of the `prefect` module, as in `prefectlegacy.context`"
        )
    ...
    def __call__(self, *args: MutableMapping, **kwargs: Any) -> Iterator["Context"]:
        ...
        Example:
            ...
            with prefectlegacy.context(dict(a=1, b=2), c=3):
                print(prefectlegacy.context.a) # 1
        """
