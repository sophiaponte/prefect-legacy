...
def jira_message_formatter(
    tracked_obj: "Union[Flow, Task]", state: "prefectlegacy.engine.state.State"
) -> str:
    time = datetime.utcnow()
    msg = "Message from prefectlegacy: {0} entered a {1} state at {2}".format(
...
def jira_notifier(
    ...
    Example:
        ...
        from prefectlegacy.utilities.jira_notification import jira_notifier
    ...
    jira_credentials = cast(dict, prefectlegacy.client.Secret("JIRASECRETS").get())
