...
class Secret:
    ...
    def exists(self) -> bool:
        ...
        if self.name in secrets:
            ...
            prefectlegacy.config.backend == "cloud"
            and prefectlegacy.context.config.cloud.use_local_secrets is False
        ):
    ...
    def get(self) -> Optional[Any]:
        ...
        Raises:
            ...
            - ClientError: if the client experiences an unexpected error communicating with the
                backend
        """
        if isinstance(prefectlegacy.context.get("flow"), prefectlegacy.core.flow.Flow):
            raise ValueError(
        ...
        try:
            ...
            if prefectlegacy.context.config.cloud.use_local_secrets is False:
                try:
                    ...
                    if "No value found for the requested key" in str(exc):
                        raise KeyError(
                            ...
                            f"was set correctly in your tenant: https://docs.prefectlegacy.io/"
