...
from prefectlegacy.serialization.task import TaskSchema
from prefectlegacy.utilities.serialization import ObjectSchema


class EdgeSchema(ObjectSchema):
    class Meta:
        object_class = lambda: prefectlegacy.core.Edge
