...
FILTERS = [
    prefectlegacy.schedules.filters.on_datetime,
    prefectlegacy.schedules.filters.on_date,
    prefectlegacy.schedules.filters.at_time,
    prefectlegacy.schedules.filters.between_datetimes,
    prefectlegacy.schedules.filters.between_dates,
    prefectlegacy.schedules.filters.between_times,
    prefectlegacy.schedules.filters.is_weekday,
    prefectlegacy.schedules.filters.is_weekend,
    prefectlegacy.schedules.filters.is_month_end,
    prefectlegacy.schedules.filters.is_day_of_week,
    prefectlegacy.schedules.filters.is_month_start,
]

ADJUSTMENTS = [
    prefectlegacy.schedules.adjustments.add,
    prefectlegacy.schedules.adjustments.next_weekday,
]


class IntervalClockSchema(ObjectSchema):
    class Meta:
        object_class = prefectlegacy.schedules.clocks.IntervalClock
...
class CronClockSchema(ObjectSchema):
    class Meta:
        object_class = prefectlegacy.schedules.clocks.CronClock
...
class DatesClockSchema(ObjectSchema):
    class Meta:
        object_class = prefectlegacy.schedules.clocks.DatesClock
...
class RRuleClockSchema(ObjectSchema):
    class Meta:
        object_class = prefectlegacy.schedules.clocks.RRuleClock
...
class ScheduleSchema(ObjectSchema):
    ...
    class Meta:
        object_class = prefectlegacy.schedules.Schedule
