...
class MetaStateSchema(BaseStateSchema):
    state = fields.Nested("prefectlegacy.serialization.state.StateSchema", allow_none=True)
...
class MappedSchema(SuccessSchema):
    ...
    map_states = fields.Nested("prefectlegacy.serialization.state.StateSchema", many=True)
