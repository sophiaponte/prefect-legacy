...
from prefectlegacy.run_configs.base import RunConfig
...
from prefectlegacy.utilities.graphql import with_args, EnumValue
...
class FlowView:
    ...
    project_name: str
    core_version: str
    storage: prefectlegacy.storage.Storage
    name: str
    flow_group_labels: List[str]

    @property
    def flow(self) -> "prefectlegacy.Flow":
        """
