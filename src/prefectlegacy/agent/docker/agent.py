...
from prefectlegacy import config, context
...
class DockerAgent(Agent):
    ...
    Docker Agent can be found at https://docs.prefectlegacy.io/orchestration/agents/docker.html
    ...
    def deploy_flow(self, flow_run: GraphQLResult) -> str:
        ...
        labels = {
            "io.prefectlegacy.flow-name": flow_run.flow.name,
            "io.prefectlegacy.flow-id": flow_run.flow.id,
            "io.prefectlegacy.flow-run-id": flow_run.id,
        }
