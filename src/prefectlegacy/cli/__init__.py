...
from prefectlegacy.utilities import backend as backend_util
...
version : {prefectlegacy.__version__}
    """
...
"""
    ...
    history_path = os.path.join(prefectlegacy.config.home_dir, "repl-history")
    prompt_kwargs = {
...
def version():
    ...
    """
    click.echo(prefectlegacy.__version__)
...
def config():
    ...
    """
    click.echo(prefectlegacy.config.to_json())
...
def diagnostics(include_secret_names):
    ...
    """
    click.echo(
        prefectlegacy.utilities.diagnostics.diagnostic_info(
