...
def cloudpickle_deserialization_check(flow_file_paths: list):
    ...
    for flow_file in flow_file_paths:
        with open(flow_file, encoding="utf-8") as f:
            try:
                # Match implementation in prefectlegacy.utilities.storage.flow_from_bytes_pickle
                ...
                warnings.warn(
                    ...
                    "https://docs.prefectlegacy.io/api/latest/storage.html#docker",
                    stacklevel=2,
                )
                raise
...
def import_flow_from_script_check(flow_file_paths: list):
    from prefectlegacy.utilities.storage import extract_flow_from_file
        ...
        for task in retry_tasks:
            if any(
                ...
                warnings.warn(
                    ...
                    f"have result types. See https://docs.prefectlegacy.io/core/concepts/results.html "
                    f"for more details.",
                    stacklevel=2,
                )
        ...
        for task in cached_tasks:
            if task.result is None:
                warnings.warn(
                    ...
                    f"See https://docs.prefectlegacy.io/core/concepts/results.html for more "
                    f"details.",
                    stacklevel=2,
                )
            if any(
                ...
                warnings.warn(
                    ...
                    f"result types. See https://docs.prefectlegacy.io/core/concepts/results.html for "
                    f"more details.",
                    stacklevel=2,
                )
    if not quiet:
