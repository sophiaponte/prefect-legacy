...
from prefectlegacy.storage import _healthcheck
from prefectlegacy.utilities import logging as prefect_logging
...
class Storage(metaclass=ABCMeta):
    ...
    Args:
        ...
        - secrets (List[str], optional): a list of Prefect Secrets which will be used to
            populate `prefectlegacy.context` for each flow run.  Used primarily for providing
    ...
    def serialize(self) -> dict:
        ...
        """
        schema = prefectlegacy.serialization.storage.StorageSchema()
