...
class Docker(Storage):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.installation_commands.append(
            f"pip show prefect || "
            f"pip install git+https://github.com/PrefectHQ/prefectlegacy.git"
    ...
    def add_flow(self, flow: "prefectlegacy.core.flow.Flow") -> str:
        """
    ...
    def get_flow(self, flow_name: str) -> "prefectlegacy.core.flow.Flow":
        """
