...
class GCS(Storage):
    ...
    Args:
        ...
        - local_script_path (str, optional): the path to a local script to upload when `stored_as_script`
            is set to `True`. If not set then the value of `local_script_path` from `prefectlegacy.context` is
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.local_script_path = local_script_path or prefectlegacy.context.get(
