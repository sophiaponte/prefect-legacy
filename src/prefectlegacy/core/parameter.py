...
from prefectlegacy.engine.serializers import DateTimeSerializer
import prefectlegacy.engine.signals
import prefectlegacy.triggers
from prefectlegacy.core.task import Task, NoDefault
from prefectlegacy.engine.results import PrefectResult
...
class Parameter(Task):
    ...
    def serialize(self) -> Dict[str, Any]:
        ...
        """
        return prefectlegacy.serialization.task.ParameterSchema().dump(self)
