...
from prefectlegacy.utilities import logging
from prefectlegacy.utilities.notifications import callback_factory
from prefectlegacy.utilities.edges import EdgeAnnotation
from prefectlegacy.utilities.tasks import as_task
    ...
    try:
        ...
        if str(exc) == "unsupported callable":
            raise ValueError(
                ...
                "https://docs.prefectlegacy.io/core/advanced_tutorials/task-guide.html#the-task-decorator"
            ) from exc
        raise
...
class TaskMetaclass(type):
            ...
            def init(self: Any, *args: Any, **kwargs: Any) -> None:
                if any(isinstance(a, Task) for a in args + tuple(kwargs.values())):
                    ...
                    warnings.warn(
                        ...
                        "see https://docs.prefectlegacy.io/core/concepts/flows.html#apis for more info.",
                        stacklevel=2,
                    )
    ...
    def _reserved_attributes(self) -> Tuple[str]:
        ...
        if not hasattr(Task, "_cached_reserved_attributes"):
            ...
            # track this task
            with prefectlegacy.context(_unused_task_tracker=set()):
    ...
    *Note:* The implemented `run` method cannot have `*args` in its signature. In addition,
    ...
    Args:
        ...
        - cache_validator (Callable, optional): Validator that will determine
            ...
            is provided; defaults to `prefectlegacy.engine.cache_validators.duration_only`)
        ...
        - checkpoint (bool, optional): if this Task is successful, whether to
            ...
            `prefectlegacy.config.flows.checkpointing` is set to `True`
        ...
        - target (Union[str, Callable], optional): location to check for task Result. If a result
            ...
            formatted at runtime with values from `prefectlegacy.context`. If a callable function
        ...
        - task_run_name (Union[str, Callable], optional): a name to set for this task at runtime.
            ...
            formatted at runtime with values from task arguments, `prefectlegacy.context`, and flow
    ...
    def __init__(
            ...
            for attr in Task._reserved_attributes:
                if hasattr(self, attr):
                    warnings.warn(
                        ...
                        "will be overwritten by `prefectlegacy.Task`. Please rename this "
        ...
        current_tags = set(prefectlegacy.context.get("tags", set()))
        self.tags = (set(tags) if tags is not None else set()) | current_tags

        max_retries = (
            max_retries
            if max_retries is not None
            else prefectlegacy.config.tasks.defaults.max_retries
        )
        retry_delay = (
            retry_delay
            if retry_delay is not None or not max_retries
            else prefectlegacy.config.tasks.defaults.retry_delay
        )
        timeout = (
            timeout if timeout is not None else prefectlegacy.config.tasks.defaults.timeout
        )
        ...
        self.trigger = trigger or prefectlegacy.triggers.all_successful
        self.skip_on_upstream_skip = skip_on_upstream_skip

        if cache_for is None and (
            cache_validator is not None
            and cache_validator is not prefectlegacy.engine.cache_validators.never_use
        ):
            warnings.warn(
        ...
        default_validator = (
            ...
            else prefectlegacy.engine.cache_validators.duration_only
        )
        ...
        if "_unused_task_tracker" in prefectlegacy.context:
            if not isinstance(self, prefectlegacy.tasks.core.constants.Constant):
                prefectlegacy.context._unused_task_tracker.add(self)
    ...
    def copy(self, **task_args: Any) -> "Task":
        ...
        flow = prefectlegacy.context.get("flow", None)
        if (
            flow
        ...
        tags = set(prefectlegacy.context.get("tags", set()))
        ...
        # warnings
        if "_unused_task_tracker" in prefectlegacy.context:
            prefectlegacy.context._unused_task_tracker.discard(self)
            if not isinstance(new, prefectlegacy.tasks.core.constants.Constant):
                prefectlegacy.context._unused_task_tracker.add(new)
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            - mapped (bool, optional): Whether the results of these tasks should be mapped over
                ...
                If `True`, any arguments contained within a `prefectlegacy.utilities.edges.unmapped`
    ...
    def bind(
        ...
        **kwargs: Any,
        ...
        flow = flow or prefectlegacy.context.get("flow", None)
        if not flow:
            ...
            task_name = (
                self.name
                if isinstance(self, prefectlegacy.tasks.core.function.FunctionTask)
    ...
    def map(
        ...
        **kwargs: Any,
        ...
        mapped over should be placed in the `prefectlegacy.utilities.edges.unmapped` container.
    ...
    def serialize(self) -> Dict[str, Any]:
        ...
        """
        return prefectlegacy.serialization.task.TaskSchema().dump(self)
    ...
    def is_equal(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.Equal().bind(self, other)
    ...
    def is_not_equal(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.NotEqual().bind(self, other)
    ...
    def not_(self) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.Not().bind(self)
    ...
    def or_(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.Or().bind(self, other)
    ...
    def __getitem__(self, key: Any) -> "Task":
        ...
        return prefectlegacy.tasks.core.operators.GetItem(
    ...
    def __add__(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.Add().bind(self, other)
    ...
    def __sub__(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.Sub().bind(self, other)
    ...
    def __mul__(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.Mul().bind(self, other)
    ...
    def __truediv__(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.Div().bind(self, other)
    ...
    def __floordiv__(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.FloorDiv().bind(self, other)
    ...
    def __mod__(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.Mod().bind(self, other)
    ...
    def __pow__(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.Pow().bind(self, other)
    ...
    def __and__(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.And().bind(self, other)
    ...
    def __radd__(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.Add().bind(other, self)
    ...
    def __rsub__(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.Sub().bind(other, self)
    ...
    def __rmul__(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.Mul().bind(other, self)
    ...
    def __rtruediv__(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.Div().bind(other, self)
    ...
    def __rfloordiv__(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.FloorDiv().bind(other, self)
    ...
    def __rmod__(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.Mod().bind(other, self)
    ...
    def __rpow__(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.Pow().bind(other, self)
    ...
    def __rand__(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.And().bind(other, self)
    ...
    def __gt__(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.GreaterThan().bind(self, other)
    ...
    def __ge__(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.GreaterThanOrEqual().bind(self, other)
    ...
    def __lt__(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.LessThan().bind(self, other)
    ...
    def __le__(self, other: object) -> "Task":
        ...
        Returns:
            - Task
        """
        return prefectlegacy.tasks.core.operators.LessThanOrEqual().bind(self, other)
