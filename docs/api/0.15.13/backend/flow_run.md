...
---
 ...
 ## FlowRunView
 <div class='class-sig' id='prefect-backend-flow-run-flowrunview'><p class="prefect-sig">class </p><p class="prefect-class">prefectlegacy.backend.flow_run.FlowRunView</p>(flow_run_id, name, flow_id, labels, parameters, context, state, states, updated_at, run_config, task_runs=None)<span class="source"><a href="https://github.com/PrefectHQ/prefect/blob/master/src/prefectlegacy/backend/flow_run.py#L325">[source]</a></span></div>
