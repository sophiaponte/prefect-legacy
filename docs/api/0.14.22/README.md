...
Read the [docs](https://docs.prefectlegacy.io); get the [code](#installation); ask us [anything](https://www.prefectlegacy.io/slack); chat with the community via [Prefect Discourse](https://discourse.prefectlegacy.io/)!
...
Finally, to register any flow with the server, call `flow.register()`. For more detail, please see the [orchestration docs](https://docs.prefectlegacy.io/orchestration/).
...
Join our [forum](https://discourse.prefectlegacy.io/) to share knowledge, discuss ideas, find answers to common questions and get support.
