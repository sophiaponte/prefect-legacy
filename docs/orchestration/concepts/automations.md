...
Automations are a feature of [Prefect Cloud](https://cloud.prefectlegacy.io) and are included with all Prefect Cloud plans. Some automation features are available only in Standard plan and above.
...
We recommend creating and managing your automations in [Prefect Cloud Automations](https://cloud.prefectlegacy.io/?automations) (Prefect Cloud login required). See the [Automations UI](/orchestration/ui/automations.html) documentation for an overview of creating and managing automations in Prefect Cloud.
